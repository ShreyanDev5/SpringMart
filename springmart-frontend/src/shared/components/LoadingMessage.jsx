...
import { FiClock, FiInfo, FiRefreshCw, FiX } from "react-icons/fi";
...
function LoadingMessage({ onDismiss, onRetry, message = "Waking Up the Store" }) {
    ...
    useEffect(() => {
        ...
        return () => clearTimeout(renderInfoTimer);
    }, []);
            ...
            {showRenderInfo && (
                <div className={styles.renderInfo}>
                    ...
                    <div className={styles.infoText}>
                        <p>Backend hosted on Render free tier. The first request after inactivity may take 2-5 minutes to wake up.</p>
                    </div>
                </div>
            )}
        </div>
